          ...
          <ul class="navbar-nav">
            ...
            <li class="dropdown">
			 ...
			 <li class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item btn btn-primary" data-toggle="modal" data-target="#exampleModal">Student Login</a>
                <a class="dropdown-item" href="blog-single.html">Teacher Login</a>
                <a class="dropdown-item" href="blog-single.html">Admin Login</a>
              </div>
            </li>
	...
	<section class="contact-page-area section-gap">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="form-area contact-form text-right" id="myForm" action="feedback_reg" method="post">
						<div class="row">
							<div class="col-lg-6 form-group">
								<input name="username" placeholder="Enter your name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'"
...
-->							</div>
							<div class="col-lg-6 form-group">
								<textarea class="common-textarea form-control" name="feedback" placeholder="Enter Messege" onfocus="this.placeholder = ''"
								 onblur="this.placeholder = 'Enter Messege'" required=""></textarea>
							</div>
							<div class="col-lg-12">
								<div class="alert-msg" style="text-align: left;"></div>
                                                                <button class="btn" type="submit" style="float: right;">Send Message</button>
							</div>
						</div>
					</form>
				</div>
