          ...
          <ul class="navbar-nav">
            ...
            <li class="dropdown">
			 ...
			 <li class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item " href="login_student.jsp">Student Login</a>
                <a class="dropdown-item" href="login_teacher.html">Teacher Login</a>
                <a class="dropdown-item" href="login_admin.html">Admin Login</a>
              </div>
            </li>
			
            <li><a href="std_admission.jsp">Apply Addmission</a></li>
      ...
      <div class="row align-items-end">
        ...
        <div class="offset-lg-3 col-lg-4 col-md-6">
          <div class="course-form-section">
            <h3 class="text-white">Any Enquiry</h3>
            <p class="text-white">It is high time for learning</p>
            <form class="course-form-area contact-page-form course-form text-right" id="myForm" action="EnquiryServlet" method="post">
              <div class="form-group col-md-12">
                <input type="text" class="form-control" id="name" name="userid" placeholder="Name" onfocus="this.placeholder = ''"
                 onblur="this.placeholder = 'Name'">
              </div>
              
              <div class="form-group col-md-12">
                <input type="email" class="form-control" id="email" name="Emailadd" placeholder="Email Address" onfocus="this.placeholder = ''"
                 onblur="this.placeholder = 'Email Address'">
              </div>
                <div class="form-group col-md-12">
                <textarea  class="form-control" id="subject" name="enquiry" placeholder="Message" onfocus="this.placeholder = ''"
